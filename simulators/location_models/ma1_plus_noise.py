...
class MA1NoiseModel(AbstractTimeSeriesModel):
    ...
    def __init__(self, c: np.ndarray, theta: np.ndarray, sigma_state: np.ndarray, sigma_noise: np.ndarray):
        # Instantiate sub-models as clean composite building blocks
